...
\begin{figure}
    \centering
    \includegraphics*[width=0.6\linewidth]{figures/bassin_default_CFL_exponential.pdf}
    \caption{Maximum amplitude of a simulated wave in a basin according to time for a value of CFL $\beta = 1.01$}
    \label{fig:CFL_exp}
\end{figure}
